...
Project done during **Software Engineering studies** at **ALX School**. It aims to learn what are makefiles, when, why and how to use them (with variables, explicit and implicit rules).
